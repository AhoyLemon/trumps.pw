...
var app = new Vue({
  ...
  methods: {
    ...
    siteByLemon: function siteByLemon() {
    ...
    pickAnotherTrump: function pickAnotherTrump() {
      var self = this;
      this.my.points = 0;
    ...
    roundSuccess: function roundSuccess() {
      ...
      var motivations = ["Keep entering passwords to earn points and unlock rewards!", "Keep entering passwords to learn the <i>truth</i> about Benghazi!", "Barack Obama will <i>hate</i> that you entered in that password!", "Crooked Hillary Clinton couldn't think of a password like that!", "You did a <i>great</i> job entering in that password!", "That's a really clever password, and we're really impressed by it.", "You're very good at entering passwords. A lot of people are saying that.", "What an <i>excellent</i> password that one is.", "You are very smart and attractive.", "If anyone tells you that was a mistake, remind them that <i>you don't make mistakes.</i>"];
